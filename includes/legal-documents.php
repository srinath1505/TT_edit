    ...
    */
    function extract_legal_document_content_fallback($html) {
      ...
      return preg_replace('/<script\b[^>]*>(.*?)<\/script>/is', "", strip_tags($html, '<p><div><h1><h2><h3><h4><h5><h6><ul><li><span><b><i><strong><em><br>'));
                        ...
                        'content_html' => '<p class="legal-doc-cert-wrap"><img src="./assets/images/cert.jpg" alt="Financial services certification and regulatory compliance document" style="max-width:100%;height:auto;border-radius:12px;display:block;" loading="lazy" decoding="async" /></p>',
                        'preview' => [],
