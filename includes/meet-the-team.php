    ...
    <section class="team-section">
        <div class="container">
            ...
            <div class="department-tabs">
                <button class="department-tab active" data-department="agents">
                    <svg class="department-tab-icon" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
                        <circle cx="9" cy="7" r="4"></circle>
                        <path d="M23 21v-2a4 4 0 0 0-3-3.87"></path>
                        <path d="M16 3.13a4 4 0 0 1 0 7.75"></path>
                    </svg>
                    <span data-i18n="meetTheTeam.departmentAgents">Agents</span>
                </button>
                <button class="department-tab" data-department="managers">
                    <svg class="department-tab-icon" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                        <circle cx="12" cy="7" r="4"></circle>
                    </svg>
                    <span data-i18n="meetTheTeam.departmentManagers">Managers</span>
                </button>
                <button class="department-tab" data-department="billing">
                    <svg class="department-tab-icon" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <rect x="1" y="4" width="22" height="16" rx="2" ry="2"></rect>
                        <line x1="1" y1="10" x2="23" y2="10"></line>
                    </svg>
                    <span data-i18n="meetTheTeam.departmentBilling">Billing</span>
                </button>
            </div>

            <!-- Agents Department -->
            <div class="department-content active" data-department="agents">
                <!-- Stacked Cards Container with Tabs -->
                <div class="team-stack-wrapper">
                    <!-- Language Tabs - Vertical on the left -->
                    <div class="team-tabs">
                    <button class="team-tab active" data-team="english">
                        <span class="tab-flag">
                        ...
                        <span data-i18n="meetTheTeam.tabEnglish">English</span>
                    </button>
                    <!-- <button class="team-tab" data-team="spanish">
                        <span class="tab-flag">
                            <svg class="flag-icon" viewBox="0 0 640 480" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <g transform="translate(320,240)">
                                    <circle r="30" fill="#f6b40e"/>
                                    <g fill="#f6b40e" stroke="#85340a" stroke-width="1">
                                        <path d="M0-45v90M-45 0h90" stroke-width="3"/>
                                        <path d="M-32-32 32 32M32-32-32 32" stroke-width="3"/>
                                        <path d="M0-40c2 8 4 12 0 20s-4 12 0 20" fill="none"/>
                                    </g>
                                </g>
                            </svg>
                        </span>
                ...
                <div class="team-stack active" data-team="english">
                    ...
                    <div class="team-indicators">
                        <button class="team-indicator active" data-index="0"></button>
                        <button class="team-indicator" data-index="1"></button>
                        <button class="team-indicator" data-index="2"></button>
                        <button class="team-indicator" data-index="3"></button>
                        <button class="team-indicator" data-index="4"></button>
                        <button class="team-indicator" data-index="5"></button>
                        <button class="team-indicator" data-index="6"></button>
                    </div>
                </div>

                <!-- Spanish Team -->
                <!-- <div class="team-stack" data-team="spanish">
                    <div class="team-cards">
                        <article class="team-card">
                            <div class="team-card-overlay"></div>
            ...
            <!-- Managers Department -->
            <div class="department-content" data-department="managers">
                <div class="team-stack-wrapper">
                    <div class="team-tabs">
                        <button class="team-tab active" data-team="managers-english">
                            <span class="tab-flag">
                                <svg class="flag-icon" viewBox="0 0 640 480" xmlns="http://www.w3.org/2000/svg">
                                    <path fill="#012169" d="M0 0h640v480H0z"/>
                                    <path fill="#FFF" d="m75 0 244 181L562 0h78v62L400 241l240 178v61h-80L320 301 81 480H0v-60l239-178L0 64V0z"/>
                    ...
                    <!-- Managers English Team -->
                    <div class="team-stack active" data-team="managers-english">
                        <div class="team-cards">
                            <article class="team-card">
                                <div class="team-card-overlay"></div>
            ...
            <!-- End Managers Department -->

            <!-- Billing Department -->
            <div class="department-content" data-department="billing">
                <div class="team-stack-wrapper">
                    <div class="team-tabs">
                        <button class="team-tab active" data-team="billing-english">
                            <span class="tab-flag">
                                <svg class="flag-icon" viewBox="0 0 640 480" xmlns="http://www.w3.org/2000/svg">
                                    <path fill="#012169" d="M0 0h640v480H0z"/>
                                    <path fill="#FFF" d="m75 0 244 181L562 0h78v62L400 241l240 178v61h-80L320 301 81 480H0v-60l239-178L0 64V0z"/>
                    ...
                    <!-- Billing English Team -->
                    <div class="team-stack active" data-team="billing-english">
                        <div class="team-cards">
                            <article class="team-card">
                                <div class="team-card-overlay"></div>
