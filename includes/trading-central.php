...
<section style="padding: 140px 0 100px; background: var(--bg-primary);">
    <div class="container">
        ...
        <div style="text-align: center; margin-bottom: 100px;">
            <img src="assets/images/trading-central.png" alt="Trading Central market research and trading insights platform" data-i18n-alt="tradingCentral.altDashboard" style="max-width: 100%; height: auto; border-radius: 24px; box-shadow: 0 20px 40px rgba(0,0,0,0.1);">
        </div>
        ...
        <div class="tc-features-grid">
            ...
            <div>
                <img src="assets/images/trading-central-mac-2.png" alt="Trading Central advanced technical analysis dashboard for traders" style="max-width: 100%; border-radius: 16px;">
            </div>
        </div>
        ...
        <div class="tc-features-grid" style="direction: rtl;">
            ...
            <div style="direction: ltr;">
                <img src="assets/images/trading-central-mac.png" alt="Trading Central desktop platform for market research and trading signals" style="max-width: 100%; border-radius: 16px;">
            </div>
        </div>
        ...
        <div class="tc-features-grid">
            ...
            <div>
                <img src="assets/images/trading-central-mob.png" alt="Trading Central market analysis tools on mobile trading platform" style="max-width: 100%; border-radius: 16px;">
            </div>
        </div>
