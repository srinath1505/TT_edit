      ...
      <div class="club-tier-grid">
        ...
        <article class="club-tier-card">
          ...
          <ul class="club-list" data-i18n-html="tradertokClubPage.tierPlatinumPlus.listHtml">
            ...
            <li>Premium financial publication subscriptions</li>
          </ul>
        </article>
    ...
    <div class="club-detail-grid">
      ...
      <article class="club-card">
        ...
        <ul class="club-list" data-i18n-html="tradertokClubPage.nextSteps.listHtml">
          ...
          <li>You will be introduced to relevant exclusive opportunities</li>
        </ul>
      </article>
    </div>
...
body.light-theme .club-card,
body.light-theme .club-section-card,
body.light-theme .club-closing-card {
  background: rgba(255, 255, 255, 0.9);
  border-color: rgba(132, 96, 74, 0.14);
  box-shadow: 0 18px 40px rgba(93, 57, 36, 0.08);
}

body.light-theme .club-card--primary,
body.light-theme .club-closing-card {
  background: linear-gradient(180deg, rgba(230, 57, 70, 0.08) 0%, rgba(255, 255, 255, 0.96) 100%);
}

body.light-theme .club-card h2,
body.light-theme .club-section-card h2,
body.light-theme .club-closing-card h2,
body.light-theme .club-tier-card h3 {
  color: #1f1712;
}

body.light-theme .club-card p,
body.light-theme .club-closing-card p,
body.light-theme .club-list li,
body.light-theme .club-tier-label,
body.light-theme .club-merch-note strong,
body.light-theme .club-tier-flow span {
  color: rgba(31, 23, 18, 0.78);
}

body.light-theme .club-tier-card,
body.light-theme .club-merch-note {
...
body.light-theme .club-merch-note span {
