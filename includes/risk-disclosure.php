  ...
  <div class="container">
    <div class="page-hero-content legal-document-content" style="justify-content: start; align-items: flex-start; text-align: left;">
      ...
      <p class="doc-page-hero-subtitle">
        ...
        movements can lead to rapid and substantial losses. You should only trade with funds you can
        afford to lose and ensure that you fully understand the risks involved before engaging in any
      ...
      <p class="doc-page-hero-subtitle">
        ...
        accordance with applicable financial regulations, including MiFID II, FCA rules, and local
        jurisdiction requirements. By trading with the Company, clients acknowledge that they have read,
        understood, and accepted all associated risks and are financially and otherwise capable of
        assuming the risks associated with trading CFDs and FX Contracts. The Customer acknowledges
        that the loss of their entire account balance will not affect their standard of living.
        Clients are responsible for ensuring that trading in CFDs, FX contracts, or other financial
        instruments is suitable for their personal financial situation, risk tolerance, and investment objectives. If
        uncertain, clients should seek independent financial advice before trading. Clients
        must also maintain sufficient funds in their account to meet margin requirements and cover
        potential losses. By trading with the Company, clients acknowledge and accept their responsibility
      ...
      <p class="doc-page-hero-subtitle">
        ...
        executions at prices significantly different from those expected. If you do not have sufficient
        liquidity to meet margin requirements, your position may be partially or fully closed, which could
        result in additional losses. For over-the-counter (OTC) contracts, including CFDs, there is also a
        counterparty risk, meaning the Company may be unable to fulfill its contractual obligations in
      ...
      <p class="doc-page-hero-subtitle">Failure to meet margin calls may result in immediate partial or full liquidation
        ...
        balance. The Company reserves the right to close any or all open positions that do not meet the
        minimum margin requirement, which may result in your CFDs or FX Contracts being closed at a
      ...
      <p class="doc-page-hero-subtitle">
        ...
        risk until the contract is closed. Clients are solely responsible for any tax treatment, reporting
        obligations, or regulatory requirements arising from their trading activity. Settlement timelines
        may vary depending on the instrument type and market conditions, and delays can occur in certain circumstances.
        Clients acknowledge and accept these risks and responsibilities when trading with
        the Company.
      </p>
      ...
      <p class="doc-page-hero-subtitle">OTC transactions may carry greater risk than on-exchange trades, as there is no
        ...
        from market prices, which can affect profitability, and the Company is not obliged to provide
      ...
      <p class="doc-page-hero-subtitle">
        ...
        including the return of any margin or collateral. Potential conflicts of interest may exist in pricing
      ...
      <p class="doc-page-hero-subtitle">
        ...
        small market fluctuations can disproportionately affect your account balance, and it is the
      ...
      <p class="doc-page-hero-subtitle">
        ...
        line with its internal policies, and these methodologies may be updated from
        time to time.
      </p>
      ...
      <p class="doc-page-hero-subtitle">
        ...
        sufficient risk analysis, carefully consider your risk tolerance, and ensure that you can manage the
      ...
      <p class="doc-page-hero-subtitle">
        ...
        nor does it confer any voting rights, dividends, or other benefits of ownership. All rights under
        these contracts are purely financial and relate solely to changes in the price of the underlying asset.
        CFDs may be based on a wide range of underlying assets, including stocks, indices, currencies,
        and commodities.
      </p>
      ...
      <p class="doc-page-hero-subtitle">
        ...
        converted into your base currency. Clients are responsible for monitoring currency risk and
        understanding its potential impact on their account. For example, if your base currency is USD
        and you hold a CFD denominated in EUR, a weakening of the EUR relative to USD could reduce
        the value of your returns, while a strengthening of the EUR could increase them. You should
        carefully consider the effect of currency movements on your potential gains and losses before
      ...
      <p class="doc-page-hero-subtitle">
        ...
        differ from other systems you may have used. Clients are strongly advised to practice using the
        demo trading system to become familiar with the Company’s platform, order execution process,
        and the risks of immediate execution before trading with real funds.<br />
        By using the online trading system, you acknowledge and accept the immediate transmission and
        execution of orders and the associated risks, including the possibility of slippage and losses in
      ...
      <p class="doc-page-hero-subtitle">
        ...
        financial instruments, including FX Contracts or CFDs. They do not constitute an offer to buy or
        sell any financial instruments, including FX Contracts or CFDs.<br />
        All decisions to enter into CFD or FX Contract trades are made independently by the Customer.
        The Company does not act as an advisor, fiduciary, or agent on behalf of the Customer and is not
      ...
      <p class="doc-page-hero-subtitle">
        ...
        strives for accuracy, it makes no representation that following its recommendations will reduce or
        eliminate the risks associated with trading CFDs or FX Contracts. Acting on these
      ...
      <p class="doc-page-hero-subtitle">
        ...
        Company or its representatives and that they are fully aware of the risks associated with trading
        CFDs and FX Contracts.<br />
        The Customer confirms that they are financially responsible for all losses and are capable of
      ...
      <p class="doc-page-hero-subtitle">
        ...
        significant market risk and may result in losses, and agrees that the Company is not liable for any
        losses, costs, or damages arising from the inability to execute orders at a requested price. Clients
        should understand that market conditions can cause rapid price fluctuations, gaps, or slippage,
        which may prevent positions from being closed at intended levels.
      </p>
      ...
      <p class="doc-page-hero-subtitle">
        ...
        Company’s control. Such issues may prevent the execution of orders, cause delays, or result in
      ...
      <p class="doc-page-hero-subtitle">
        ...
        In the event of a quoting error, the Company is not liable for any resulting discrepancies in account
        balances. The Company reserves the right, acting in good faith, to correct such errors and make
        any necessary adjustments to the relevant account. Any such adjustments may affect both realized
        and unrealized gains or losses in the Customer’s account.
        If there is a discrepancy between the quoted price and the actual market price, the Company will
        make reasonable efforts to execute the transaction as close to the prevailing market price as
        possible. The prevailing market prices will ultimately be reflected in the Customer’s account
        statements. Clients acknowledge and accept that quoting errors are a risk of trading and that the
        Company is not responsible for losses resulting from such errors.
        Should a Customer wish to raise a concern or submit a formal complaint regarding a trade or
        quoting issue, they must do so in writing to the Company’s Compliance Department at <a
          href="mailto:compliance@tradertok.com" class="license-link">compliance@tradertok.com</a>.
        Complaints must include all relevant trade details and must be
      ...
      <p class="doc-page-hero-subtitle">
        ...
        market conditions. Clients are encouraged to review the updated disclosures before entering into
        any trades to ensure they are aware of all applicable risks.
      </p>
    </div>
  </div>
</section>
