    ...
    <footer class="footer">
      <div class="container">
        ...
        <!-- Row 1: Social icons + Instrument columns -->
        <div class="footer-top footer-row-1">
            ...
            <div class="footer-social-icons">
              <a href="https://x.com/traderttok" class="footer-social-link" aria-label="X / Twitter">
                <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
                  <path
                    d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.742l7.727-8.836L2.25 2.25h6.893l4.263 5.638zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="https://www.facebook.com/profile.php?id=61587873671208" class="footer-social-link"
                aria-label="Facebook">
                <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
                  <path
              ...
              <a href="https://www.tiktok.com/@tradertokglobal" class="footer-social-link" aria-label="TikTok">
                <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
                  <path
                    d="M19.589 6.686a4.793 4.793 0 0 1-3.77-4.204h-3.136v13.512a2.728 2.728 0 1 1-2.728-2.728c.213 0 .42.025.62.071V10.12a5.86 5.86 0 0 0-.62-.033 5.864 5.864 0 1 0 5.864 5.864V9.27a8.003 8.003 0 0 0 4.771 1.573V7.707a4.768 4.768 0 0 1-1-.021z" />
                </svg>
              </a>
            </div>
          </div>
          ...
          <!-- Top Instruments -->
          <div class="footer-column">
            <a href="<?php echo routeUrl('top-instruments'); ?>" class="footer-title footer-title-link"
              data-i18n="footer.topInstruments">Top Instruments</a>
            <ul class="footer-links">
              ...
              <li><span class="footer-link" data-i18n="footer.shiba">Shiba (In Millions)</span></li>
              <li><span class="footer-link" data-i18n="footer.tesla">Tesla</span></li>
              <li><span class="footer-link" data-i18n="footer.apple">Apple</span></li>
              <li><span class="footer-link" data-i18n="footer.nio">Nio</span></li>
            </ul>
          </div>
          ...
          <div class="footer-column">
            ...
            <ul class="footer-links">
              <li><a href="<?php echo routeUrl('help-center'); ?>" class="footer-link"
                  data-i18n="footer.helpCenter">Help Center</a></li>
              <li><a href="<?php echo routeUrl('how-to-deposit'); ?>" class="footer-link"
                  data-i18n="footer.howToDeposit">How to deposit</a></li>
              <li><a href="<?php echo routeUrl('how-to-withdraw'); ?>" class="footer-link"
                  data-i18n="footer.howToWithdraw">How to withdraw</a></li>
              <li><a href="<?php echo routeUrl('how-to-open-account'); ?>" class="footer-link"
                  data-i18n="footer.howToOpenAccount">How to Open an Account</a></li>
              <li><a href="<?php echo routeUrl('how-to-verify-account'); ?>" class="footer-link"
                  data-i18n="footer.howToVerifyAccount">How to verify your account</a></li>
              <li><a href="contact-us" class="footer-link" data-i18n="footer.contactUs">Contact Us</a></li>
              <li><a href="<?php echo routeUrl('client-vulnerability'); ?>" class="footer-link"
                  data-i18n="footer.clientVulnerability">Client Vulnerability</a></li>
          ...
          <div class="footer-column">
            ...
            <ul class="footer-links">
              <li><a href="how-copy-trading-works" class="footer-link" data-i18n="footer.howCopyTradingWorks">How
                  CopyTrading Works</a></li>
              <li><a href="responsible-trading" class="footer-link" data-i18n="footer.responsibleTrading">Responsible
                  Trading</a></li>
              <li><a href="interest-on-balance" class="footer-link" data-i18n="footer.interestOnBalance">Interest on
                  Balance</a></li>
              <li><a href="what-is-leverage-and-margin" class="footer-link"
                  data-i18n="footer.whatIsLeverageAndMargin">What is Leverage &amp; Margin</a></li>
        ...
        <!-- Row 2: App Download + Link columns -->
        <div class="footer-top footer-row-2">
          ...
          <div class="footer-column">
            ...
            <div class="footer-store-btns">
              ...
              <a href="https://play.google.com/store/apps/details?id=com.tradertok.app" class="footer-store-btn">
                <svg class="store-icon" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <linearGradient id="gp-a" x1="61.634" x2="233.38" y1="474.99" y2="255.12"
                    ...
                    <linearGradient id="gp-b" x1="271.85" x2="131.4" y1="256" y2="256" gradientUnits="userSpaceOnUse">
                      <stop offset="0" stop-color="#ffe000" />
                      <stop offset=".409" stop-color="#ffbd00" />
                      <stop offset=".775" stop-color="orange" />
                      <stop offset="1" stop-color="#ff9c00" />
                    </linearGradient>
                    <linearGradient id="gp-c" x1="162.07" x2="314.18" y1="282.1" y2="440.97"
                      gradientUnits="userSpaceOnUse">
                      <stop offset="0" stop-color="#ff3a44" />
                      <stop offset="1" stop-color="#c31162" />
                    </linearGradient>
                    <linearGradient id="gp-d" x1="113.67" x2="188.5" y1="70.44" y2="158.24"
                      gradientUnits="userSpaceOnUse">
                  ...
                  <path
                    d="M64.37 18.51c-6.18 6.59-9.84 16.66-9.84 29.78v415.42c0 13.13 3.66 23.2 9.84 29.78l1.56 1.52 232.6-232.6v-5.48L65.93 24.99z"
                    fill="url(#gp-a)" />
                  <path
                    d="M375.07 339.82l-77.54-77.56v-12.51l77.54-77.54 1.75 1 91.93 52.23c26.26 14.92 26.26 39.34 0 54.26l-91.93 52.23z"
                    fill="url(#gp-b)" />
                  <path d="M376.82 338.82L297.53 256 64.37 493.29c8.65 9.16 22.95 10.29 38.98 1.15z"
                    fill="url(#gp-c)" />
                  <path d="M376.82 173.18L103.35 17.56C87.32 8.42 73.02 9.55 64.37 18.71L297.53 256z"
                    fill="url(#gp-d)" />
                </svg>
            ...
            <!-- Visa & Mastercard BELOW the store buttons -->
            <div class="footer-payment-icons footer-payment-row">
          ...
          <div class="footer-column">
            ...
            <ul class="footer-links">
              ...
              <li><a href="<?php echo routeUrl('accessibility'); ?>" class="footer-link"
                  data-i18n="footer.accessibility">Accessibility</a></li>
            </ul>
          </div>
          ...
          <div class="footer-column">
            ...
            <ul class="footer-links">
              ...
              <li><a href="regulations" class="footer-link" data-i18n="nav.regulations">Regulation &amp; License</a>
              </li>
              <li><a href="general-risk-disclosure" class="footer-link" data-i18n="nav.generalRiskDisclosure">General
                  Risk Disclosure</a></li>
              <li><a href="terms-conditions" class="footer-link" data-i18n="nav.termsConditions">Terms &amp;
                  Conditions</a></li>
              ...
              <li><a href="<?php echo routeUrl('key-information-documents'); ?>" class="footer-link"
                  data-i18n="footer.keyInformationDocuments">Key Information Documents</a></li>
            </ul>
          </div>
          ...
          <div class="footer-column">
            ...
            <ul class="footer-links">
              <li><a href="<?php echo routeUrl('invite-a-friend'); ?>" class="footer-link"
                  data-i18n="footer.inviteAFriend">Invite a friend</a></li>
              <li><a href="<?php echo routeUrl('ib-program'); ?>" class="footer-link" data-i18n="footer.ibProgram">IB
                  Program</a></li>
              <li><a href="<?php echo routeUrl('tradertok-club'); ?>" class="footer-link"
                  data-i18n="footer.traderTokClub">TraderTok Club</a></li>
              <li><a href="<?php echo routeUrl('segregated-account'); ?>" class="footer-link"
                  data-i18n="footer.segregatedAccount">Segregated Account</a></li>
              <li><a href="offers-promotions" class="footer-link" data-i18n="footer.offersAndPromotions">Offers &amp;
                  Promotions</a></li>
            </ul>
          </div>
        ...
        <div class="footer-bottom">
          <div class="footer-legal">
            <p class="footer-copyright" data-i18n-html="footer.copyright">&copy; <script>
              document.write(new Date().getFullYear());
              </script> Amber Rock Trade Ltd. Level 5, Alexander House, 35 Cybercity, 72201 Ebene, Mauritius. Company
              No: 222594. <a href="https://opr.fscmauritius.org/ords/opr/r/fsc-opr/fsc-online-public-register-opr"
                target="_blank" class="license-link">License No: GB24203892</a>. Amber Rock Trade Ltd is authorized and
              regulated by the Financial Services Commission of Mauritius (FSC).</p>

            <p class="footer-copyright-extra" data-i18n="footer.copyright-extra">This website is operated by Amber Rock
              Trade Ltd.</p>
            ...
            <p class="footer-risk-warning" data-i18n-html="footer.riskWarningHtml"><span class="risk-warning-title">Risk
                Warning:</span> Trading in derivative financial instruments, including CFDs and other leveraged
              products, carries a high level of risk and may not be suitable for all investors. You may lose all or more
              than your initial investment. Trading is subject to market volatility, leverage risk, and other risks. You
              should only trade with funds you can afford to lose. Before engaging in trading activities, please ensure
              that you fully understand the risks involved, your financial objectives, and your level of experience. If
              necessary, seek independent professional advice. Please refer to our full Risk Disclosure Statement for
    ...
    <script src="assets/js/instruments-script.js?v=<?php echo filemtime('assets/js/instruments-script.js'); ?>" defer>
    </script>
    <?php endif; ?>
    <?php if (!empty($page) && $page === 'ib-program'): ?>
    <script src="assets/js/ib-program-meta.js?v=<?php echo filemtime('assets/js/ib-program-meta.js'); ?>" defer>
    </script>
    <?php endif; ?>
    ...
    <script src="assets/js/tradertok-club-meta.js?v=<?php echo filemtime('assets/js/tradertok-club-meta.js'); ?>" defer>
    </script>
    <?php endif; ?>
    <?php if (!empty($page) && $page === 'account-types'): ?>
    <script src="assets/js/account-types-meta.js?v=<?php echo filemtime('assets/js/account-types-meta.js'); ?>" defer>
    </script>
    <?php endif; ?>
    <?php if (!empty($page) && $page === 'education-hub'): ?>
    <script src="assets/js/education-hub-meta.js?v=<?php echo filemtime('assets/js/education-hub-meta.js'); ?>" defer>
    </script>
    <?php endif; ?>
