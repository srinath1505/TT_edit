    ...
    <header class="header">
        <div class="container">
            <div class="header-content">
                ...
                <div class="header-actions">
                    ...
                    <div class="language-selector">
                        <button class="language-btn" id="languageBtn" aria-label="Select language">
                            ...
                            <svg class="language-arrow" width="10" height="10" viewBox="0 0 10 10" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <!-- Mobile menu button -->
                <button class="mobile-menu-btn" aria-label="Toggle navigation menu" aria-expanded="false" aria-controls="main-navigation">
                    <span></span>
                    <span></span>
                    <span></span>
                </button>
            ...
            <form class="auth-form" id="signupForm" data-form="signup">
                ...
                <div class="auth-form-group">
                    ...
                    <div class="auth-phone-input">
                        ...
                        <input type="tel" id="signup-phone" class="auth-input phone-number-input" placeholder="7520 640 890" required>
                    </div>
