...
<section class="hero gold-silver-banner" aria-label="TraderTok banner">
  <img src="assets/images/banner.jpeg" alt="TraderTok online trading platform for forex, stocks and CFDs" class="banner-img">
  ...
  <div class="container">
    <div class="about-content">
      ...
      <div class="about-text">
        ...
        <a href="about" class="btn-primary" data-i18n="hero.learnMore" style="text-decoration: none;">Learn More</a>
      </div>
  ...
  <div class="container">
    <div class="traders-club-card">
      ...
      <div class="traders-club-image">
        <img src="assets/images/card-tradertok.png" alt="TraderTok payment card for secure deposits and withdrawals" loading="lazy">
      </div>
    </div>
  </div>
</section>
    ...
    <div id="tradersClubModalBody">
      ...
      <form class="traders-club-form" id="tradersClubForm" novalidate>
        <div class="traders-club-mode" role="group" aria-labelledby="tradersClubModeLabel">
          <span id="tradersClubModeLabel" class="traders-club-mode-label" data-i18n="tradersClub.choosePath">How would
        ...
        <div id="tradersClubPanelExisting" class="traders-club-panel">
          <div class="form-group">
            ...
            <input type="email" id="clubEmailExisting" name="email_existing"
              data-i18n-placeholder="tradersClub.emailPlaceholder" placeholder="Enter your email" autocomplete="email">
          </div>
          <p class="traders-club-hint" data-i18n="tradersClub.existingHint">We’ll check your Traders Club eligibility
            using your account email.</p>
        </div>
      ...
      <div class="platforms-visual">
        <div class="device-wrapper">
          <img src="assets/images/devices-mockup.png"
            alt="TraderTok online trading platform available across desktop, tablet and mobile devices" class="devices-img"
            loading="lazy" />
      ...
      <div class="accordion-item">
        ...
        <div class="accordion-content">
          <div class="accordion-body"
            <?php echo $i18nSuffix ? 'data-i18n="instruments.' . $i18nSuffix . 'Desc"' : ''; ?>>
  ...
  <div class="container">
    <div class="deposit-card">
      ...
      <div class="deposit-image">
        <img src="assets/images/7.6.png" alt="TraderTok customer rating and trading platform review score" loading="lazy">
      </div>
    </div>
  </div>
</section>
    ...
    <div id="depositModalBody">
      ...
      <form class="deposit-form" id="depositForm" novalidate>
        <div class="traders-club-mode" role="group" aria-labelledby="depositModeLabel">
          <span id="depositModeLabel" class="traders-club-mode-label" data-i18n="deposit.choosePath">How would you like
            to continue?</span>
          <div class="traders-club-mode-toggle">
            <label class="traders-club-mode-option">
        ...
        <div id="depositPanelExisting" class="traders-club-panel">
          <div class="form-group">
            ...
            <input type="email" id="depositEmailExisting" name="email_existing"
              data-i18n-placeholder="deposit.emailPlaceholder" placeholder="Enter your email" autocomplete="email">
          </div>
          <p class="traders-club-hint" data-i18n="deposit.existingHint">We’ll check your eligibility using your account
            email.</p>
        </div>
        ...
        <button type="submit" class="btn-submit-deposit" id="depositSubmit"
          data-i18n="deposit.continueEligible">Continue</button>
      </form>
  ...
  <div class="container">
    <div class="telegram-card">
      <div class="telegram-info">
        <h2 class="telegram-title" data-i18n-html="telegram.title">Join Our <span class="gradient-text">Community</span>
        </h2>
      ...
      <div class="telegram-person">
        <img src="assets/images/Person holding phone happily.png" alt="Happy investor using TraderTok mobile trading app for online investing" loading="lazy">
      </div>
...
<section class="trustpilot-section">
  <div class="container">
    ...
    <?php
    /** Default copy for first paint / no-JS; live language uses locales/*.json (clientTestimonials.items.*). */
    $home_client_testimonials = [
        ['name' => 'Bunny', 'text' => 'Everything runs smoothly and the platform is very easy to use. A big thank you to David Faris, his professionalism and support are truly top-tier. He goes above and beyond to help.', 'stars' => 5],
        ['name' => 'Frank B', 'text' => 'My experience has been excellent. Dominic Weber has been incredibly helpful and accommodating throughout, making the entire process simple and stress-free.', 'stars' => 5],
        ['name' => 'Mark Telford', 'text' => 'Amazing experience overall. The platform is easy to navigate and very reliable. David Faris has been outstanding with his support and guidance.', 'stars' => 5],
        ['name' => 'Dody Chandra Petrus', 'text' => 'This is my first time trading and the experience has been great so far. Dominic Weber has been very supportive and always available to assist whenever needed.', 'stars' => 5],
        ['name' => 'Kenneth Umaid', 'text' => 'Great service and smooth experience. Everything works exactly as expected. Special thanks to David Faris for his consistent support and professionalism.', 'stars' => 5],
        ['name' => 'Indira Sammy', 'text' => 'Very satisfied with the overall experience. The platform is user-friendly and efficient. Dominic Weber has been extremely helpful and responsive throughout.', 'stars' => 5],
        ['name' => 'Chris', 'text' => 'The support from Mr. Simon Bjork, along with the team, Lucas, Roy, and Brooke, has been exceptional from the very beginning. They guided me through the initial stages of trading, including financial transfers and ongoing training sessions, always responding quickly and clearly to any questions. Their encouragement during market fluctuations has been especially reassuring, and I have full confidence in their advice and integrity. This experience has built a strong sense of trust, and I look forward to continuing this journey with them.', 'stars' => 5],
    ];
    ...
    <section class="client-testimonials-section client-testimonials-section--under-trustpilot"
      aria-labelledby="client-testimonials-heading">
      <div class="client-testimonials-header">
        <h2 id="client-testimonials-heading" class="client-testimonials-title" data-i18n="clientTestimonials.title">
          Client testimonials</h2>
        <p class="client-testimonials-subtitle" data-i18n="clientTestimonials.subtitle">What traders say about their
          experience with us</p>
      </div>

      <div class="client-testimonials-slider">
        <div class="client-testimonials-row">
          <button type="button" class="client-testimonials-btn client-testimonials-btn--side"
            id="clientTestimonialsPrev" aria-label="Previous testimonial" data-i18n-aria="clientTestimonials.prevAria">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <div class="client-testimonials-viewport">
            <div class="client-testimonials-track" id="clientTestimonialsTrack">
              <?php foreach ($home_client_testimonials as $ti => $item) :
                ...
                $itemKey = 'clientTestimonials.items.' . $ti;
                ?>
              <div class="client-testimonials-card<?php echo $ti === 0 ? ' active' : ''; ?>">
                <?php if ($authorName !== '') : ?>
                <div class="client-testimonials-author"
                  style="--accent: <?php echo htmlspecialchars($bg, ENT_QUOTES, 'UTF-8'); ?>;">
                  <p class="client-testimonials-author-name"
                    data-i18n="<?php echo htmlspecialchars($itemKey . '.name', ENT_QUOTES, 'UTF-8'); ?>">
                    <?php echo htmlspecialchars($authorName, ENT_QUOTES, 'UTF-8'); ?></p>
                </div>
                <?php endif; ?>
                <p class="client-testimonials-quote"
                  data-i18n="<?php echo htmlspecialchars($itemKey . '.text', ENT_QUOTES, 'UTF-8'); ?>">
                  <?php echo htmlspecialchars($item['text'], ENT_QUOTES, 'UTF-8'); ?></p>
                <div class="client-testimonials-stars" aria-label="5 out of 5 stars"
                  data-i18n-aria="clientTestimonials.starsFive">
                  <?php
                for ($s = 1; $s <= 5; $s++) {
                    $full = $s <= $stars;
          ...
          <button type="button" class="client-testimonials-btn client-testimonials-btn--side"
            id="clientTestimonialsNext" aria-label="Next testimonial" data-i18n-aria="clientTestimonials.nextAria">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <div class="home-payment-overview__visual" data-i18n-aria="homePayment.visualAriaLabel" aria-label="Payment methods">
            <div class="home-payment-overview__icon-grid">
              <div class="home-pay-methods-row">
                ...
                <div class="home-payment-overview__icon-tile home-payment-overview__icon-tile--brand">
                  <img src="./assets/images/Mastercard-logo.svg.png" alt="TraderTok Payment Card and Account Benefits" class="home-payment-overview__brand-img home-payment-overview__brand-img--mastercard" width="120" height="75" loading="lazy" data-i18n-alt="homePayment.mastercardAlt">
                </div>
              ...
              <div class="home-pay-wallets">
                ...
                <div class="home-pay-wallets__grid" role="list">
                  ...
                  <div class="home-payment-overview__wallet-chip home-payment-overview__wallet-chip--mm" role="listitem" data-i18n-aria="homePayment.walletMobileMoneyAria" aria-label="Mobile money">
                    <img src="./assets/images/mm.jpg" alt="Professional trader analyzing market opportunities with TraderTok" class="home-payment-overview__wallet-mm-img" width="120" height="56" loading="lazy" data-i18n-alt="homePayment.walletMobileMoneyAria">
                  </div>
