    <style>
        ...
        .account-card.tier-1 { --price-color: #4ADE80; }
        .account-card.tier-2 { --price-color: #A78BFA; }
        .account-card.tier-3 { --price-color: #60A5FA; }
        .account-card.tier-4 { --price-color: #F472B6; }
        .account-card.tier-5 { --price-color: #D4AF37; }
