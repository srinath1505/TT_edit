        ...
        <div class="container">
          <div class="offers-hero-content">
            <h1 class="offers-title">
              <span data-i18n="offersPage.heroTitle">Trading</span>
              <span class="" data-i18n="offersPage.heroTitleHighlight">Offers &amp; Promotions</span>
            </h1>
            <p class="offers-subtitle" data-i18n="offersPage.heroSubtitle">Discover region-specific promotions and
              exclusive trading opportunities tailored for traders in your area.</p>
          </div>
        </div>
      </section>
      ...
      <section class="offers-split">
        <div class="container">
          ...
          <div class="offers-mobile-selector">
            <label for="regionDropdown" class="region-dropdown-label" data-i18n="offersPage.selectRegion">Select Your
              Region</label>
            <div class="region-dropdown-container">
              <select id="regionDropdown" class="region-dropdown">
                <option value="" disabled selected data-i18n="offersPage.selectRegionPlaceholder">— Select a Region —
                </option>
                ...
                <option value="trinidad-tobago" data-i18n="offersPage.regions.trinidad-tobago">Trinidad & Tobago
                </option>
          ...
          <div class="offers-split-layout">
            <!-- Left Sidebar -->
            <aside class="offers-sidebar" id="offersSidebar" data-i18n-aria="offersPage.sidebarAria"
              aria-label="Country selection">
              <div class="offers-sidebar-header">
                <h2 class="offers-sidebar-title" data-i18n="offersPage.selectRegion">Select Region</h2>
              </div>
              <nav class="offers-sidebar-list" id="sidebarCountryList" role="listbox"
                data-i18n-aria="offersPage.listboxAria" aria-label="Countries">
            ...
            <div class="offers-content" id="offersContent">
              ...
              <div class="offers-content-header" id="promotionsHeader" style="display: none;">
                ...
                <button class="promotions-clear-btn" id="clearRegion" data-i18n="offersPage.clearSelection">Clear
                  Selection</button>
              </div>
              ...
              <div class="offers-content-empty" id="promotionsEmpty">
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                  ...
                  style="color: var(--text-tertiary); margin-bottom: 16px;">
              ...
              <div class="offers-content-cta" id="offersContentCta">
                <div class="offers-cta-inner">
                  ...
                  <p class="offers-cta-subtitle" data-i18n="offersPage.ctaSubtitle">Open your account today and take
                    advantage of these exclusive offers.</p>
                  <a href="<?php echo htmlspecialchars(routeUrl('open-live-account')); ?>" class="btn-offers-cta"
                    data-i18n="offersPage.ctaButton">Get
                    Started</a>
                </div>
              </div>
            </div>
